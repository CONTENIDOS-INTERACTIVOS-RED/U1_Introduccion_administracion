        ...
        subMenu: [
          {
            ...
            numero: '2.1',
            titulo:
              'Enfoque científico y clásico en la administración de empresas',
            hash: 't_2_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.2',
            titulo: 'Enfoque humanista en la administración de empresas',
            hash: 't_2_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.3',
            titulo: 'Otros enfoques',
            hash: 't_2_3',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.4',
            titulo: 'Enfoque de sistemas en la administración de empresas',
            hash: 't_2_4',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.5',
            titulo: 'Enfoque situacional en la administración de empresas',
            hash: 't_2_5',
          },
        ],
      },
